                    ...
                    >
                        ...
                        <nav className="mt-6">
                            <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                                ...
                                {!user && <MobileNavItem href="/login">Login</MobileNavItem>}
                            </ul>
                        </nav>
                    </Popover.Panel>
                </Transition.Child>
    ...
    return (
        <li>
            <button
                ...
                type="submit"
                aria-label="button"
                className={clsx('relative block px-3 py-2 transition hover:text-teal-500 dark:hover:text-teal-400')}
            >
                {children}
            </button>
        </li>
    ...
    return (
        <nav {...props}>
            <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
                ...
                {user ? <NavButton onClick={handleLogout}>Logout</NavButton> : <NavItem href="/login">Login</NavItem>}
            </ul>
        </nav>
    );
}
